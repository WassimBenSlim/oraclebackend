...
class ExpertiseLogicielle {
  static async create({ expertiseName, expertiseName_en }) {
    const id = uuidv4();
    const sql = `
      INSERT INTO expertise_logicielles (id, expertiseName, expertiseName_en, createdAt, updatedAt)
  ...
  static async findAll(searchTerm = '') {
    const sql = `
      SELECT * FROM expertise_logicielles
...
module.exports = ExpertiseLogicielle;