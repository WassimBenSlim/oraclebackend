...
const { createSavedFiltersTable } = require("./create-saved-filters-table")
const { createSavedFiltersIndexes } = require("./create-saved-filters-indexes")
...
const runMigrations = async () => {
  try {
    ...
    await createSavedFiltersIndexes()
